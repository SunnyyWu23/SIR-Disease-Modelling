...
with open("simulated_Nigeria_2014_2016.csv", 'w', newline='') as file:
    ...
    while t < 121:
        ...
        arg = max(1,-dSdt) # prevent math domain error when dSdt becomes negative
        if t < t_switch:
            dIdt = math.log(arg,2)/0.01 - v * I # MODIFICATION TO SIR
        else: 
            dIdt = math.log(arg,30) - v * I # MODIFICATION TO SIR
...
plot.title("Nigeria - Cumulative People Infected and Dead")
plot.xlabel("Months")
