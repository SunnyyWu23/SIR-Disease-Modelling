...
# Added cumulative infected and dead column to match data 
# No data for number of recovered people so we disregarded this info 

# SIR initial values for Liberia
# Population ≈ 4,300,000, initial cumulative cases = 1378, deaths = 694
S = 4350000 - 1378 - 694   # susceptible
...
with open("simulated_Liberia_2014_2016.csv", 'w', newline='') as file:
    ...
    while t < 121:
        ...
        if t < t_switch:
            dIdt = math.log(-(dSdt),2)/0.01 - v * I # MODIFICATION TO SIR
        else: 
            dIdt = math.log(-(dSdt),30) - v * I # MODIFICATION TO SIR

        # Split removals into recovered and dead
        dRdt = (1.0 - fatality_frac) * v * I # Split removed into recovered and dead
...
plot.title("Liberia - Cumulative People Infected and Dead")
plot.xlabel("Months")
